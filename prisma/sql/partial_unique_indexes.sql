-- Partial unique indexes for soft-deletable records.
-- Prisma schema cannot express "unique where deletedAt is null"; keep this SQL
-- in the initial migration whenever the schema is migrated to PostgreSQL.
