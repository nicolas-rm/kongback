...
@Module({
    ...
    providers: [NotificationsRepository, NotificationsSocketAuthenticationService, NotificationsSerializerService, NotificationsRealtimeService, NotificationsGateway, NotificationsService],
